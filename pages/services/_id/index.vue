    ...
    <section class="text-gray-600 body-font">
      ...
      >
        <div class="w-5/6 h-full mb-10 lg:max-w-lg lg:w-full md:w-1/2 md:mb-0">
          ...
          /> -->
          <client-only
            ><iframe :src="test.video_url" frameborder="0"></iframe
          ></client-only>
        </div>
        <div
        ...
        >
          ...
          <p class="mb-20 leading-relaxed lg:text-xl">
            ...
            interdum nisl pellentesque pharetra pharetra. Proin scelerisque
            turpis risus, sed bibendum odio cursus vel. Aenean tempus sed magna
            a varius. Class aptent taciti sociosqu ad litora torquent per
            conubia nostra, per inceptos himenaeos. Donec cursus eros risus,
            quis malesuada tellus aliquet vitae. Cras eget congue eros. Sed
            libero purus, porttitor a tellus at, lobortis faucibus lectus. Sed
            tempor nec sapien sit amet efficitur. Nullam ullamcorper, lacus ac
            semper cursus, metus nunc sollicitudin orci, quis pharetra justo
            lorem quis risus. Aenean aliquam erat mollis erat dapibus, ac
            interdum lorem venenatis.
          </p>
